...
Esta página apresenta a análise estática utilizada no cálculo da **M5 - Independência de componentes** no backend TypeScript.
...
| :----- | :--- | :-------- | :-------- |
| 1.0 | 12/06/2026 | Registro do mapa de dependências e cálculo da M5 | [Caio Duarte](https://github.com/caioduart3) |
| 1.1 | 12/06/2026 | Restrição da análise ao backend TypeScript e inclusão dos comandos de reprodução | [Caio Duarte](https://github.com/caioduart3) |
| 1.2 | 12/06/2026 | Inclusão das capturas da execução do Madge como evidências | [Caio Duarte](https://github.com/caioduart3) |
| 1.3 | 13/06/2026 | Alinhamento da redação da fórmula com as Fases 2 e 3 | [Caio Duarte](https://github.com/caioduart3) |
| 1.4 | 13/06/2026 | Adequação do nome e da fórmula à dependência interna efetivamente medida | [Caio Duarte](https://github.com/caioduart3) |
